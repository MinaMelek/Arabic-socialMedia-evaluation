...
PriceBooking_inquiry = set(['العرض', 'رقم', 'تفاصيل', 'خدمة', 'حجزت', 'متواجد', 'ميعاد', 'التركيبات', 'تكلفتها', 'جوالي', 'سجلت', 'خصومات', 'سعر', 'التليفون', 'لحجز', 'كم', 'وكم', 'تليفون', 'للحجز', 'علاج', 'عرض', 'الخدمة', 'موعد', 'سعرها', 'التكاليف', 'احجز', 'مناسب', 'والاسعار', 'اتواصل', 'تكلف', 'سعره', 'التفاصيل', 'وبكم', 'تلفون', 'الهاتف', 'اسعار', 'التواصل', 'عايزه', 'السعر', 'حجز', 'اخر', 'الموعد', 'ارسال', 'نحجز', 'مواعيد', 'زرع', 'كلف', 'تتكلف', 'تكلفة', 'الحجز', 'وكام', 'عروض', 'التكلفة', 'يكلف', 'ماهي', 'عاوز', 'الرقم', 'معرفة', 'كام', 'ارقام', 'وقت', 'تكلفه', 'التكلفه', 'مبلغ', 'بكم', 'بدي', 'جوال', 'بكام'])
...
general = set(['انا_عندي' ,'عندي' ,'علاج' ,'كيف', 'علم', 'رجاء', 'محتاج', 'عايز', 'عاوز', 'تفاصيل', 'ارجو', 'عرف', 'عارف', 'اعرف', 'هل', 'ايش', 'ايه', 'ازاي', 'معلش', 'سمح', 'سمحت', 'لو_سمحت', 'لوسمحت', 'مين', 'ياريت', 'ممكن', 'ليه'])

PriceBooking_inquiry -= price
PriceBooking_inquiry -= datetime
PriceBooking_inquiry -= service
PriceBooking_inquiry -= Medical_conslut
PriceBooking_inquiry -= general
